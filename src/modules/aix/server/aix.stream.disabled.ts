...
// Use with: testGenerate: publicProcedure.mutation(testStreamStress),
export async function* testStreamStress(except: boolean) {
  console.log('Input received, starting generation');
