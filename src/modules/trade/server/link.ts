      ...
      data: {
        ...
        expiresAt:
          expiresSeconds === 0
            ...
            : new Date(Date.now() + 1000 * (expiresSeconds ?? (DEFAULT_EXPIRES_SECONDS as any))), // default
        deletionKey: uuidv4(),
        isDeleted: false,
      },
    });
 ...
 */
export const storageUpdateDeletionKeyProcedure = publicProcedure
