...
export function MidoriAISourceSetup(props: { sourceId: DModelSourceId }) {
  ...
  return <>
    ...
    <Typography level='body-sm' sx={{ whiteSpace: 'break-spaces', mt: 0.5, ml: 0.1 }}>
      ...
      Please use this link to get a API Key - 
      <Link href='https://tea-cup.midori-ai.xyz/stream-file/568fa97410b2770fe337c06e65a1ce2cdfb24e9cffb238e0ce2003d09b606cc110fe44d6b2fab803beb40f70c5b86ff4.txt' target='_blank'>Get API Key</Link><br /><br />
