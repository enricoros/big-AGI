...
export function vendorHasBackendCap<TServiceSettings = unknown, TAccess = unknown, TLLMOptions = unknown>(vendor: IModelVendor<TServiceSettings, TAccess, TLLMOptions>) {
