...
// Pricing based on https://ai.google.dev/pricing (Jan 8, 2026)
...
const _knownGeminiModels: ({
  ...
  // 2.0 Flash Live - DEPRECATED: shut down December 9, 2025
  {
    ...
    hidden: true, // shut down December 9, 2025 per changelog
