...
export function PageBar(props: {
  ...
  // external state
  const { appBarItems, appDrawerContent, appMenuItems } = useOptimaLayout();
  ...
  return (
    <>
      ...
      <InvertedBar component={props.component} direction="horizontal" sx={props.sx}>
        ...
        >
          {appBarItems ? appBarItems : <PageBarItemsFallback currentApp={props.currentApp} />}
        </Box>
      ...
      <CloseableMenu
        ...
        open={isPageMenuOpen && !!pageMenuAnchor.current}
        anchorEl={pageMenuAnchor.current}
